...
for (i in 1:length(contrast_list$contrast)){
  ...
  print(dotplot(GO.BP, showCategory=30) + ggtitle("GO:Biological Process"))
  print(emapplot(GO.BP) + ggtitle("GO:Biological Process"))
  #print(cnetplot(GO.BP, foldChange=geneList) + ggtitle("GO:Biological Process"))
  
  cat("\n\n##### GO: Molecular Function \n\n")
  print(dotplot(GO.MF, showCategory=30) + ggtitle("GO:Molecular Function"))
  print(emapplot(GO.MF) + ggtitle("GO:Molecular Function"))
  #cnetplot(GO.MF, foldChange=geneList) + ggtitle("GO:Molecular Function")
  
  cat("\n\n##### GO: Cellular Compartment \n\n")
  print(dotplot(GO.CC, showCategory=30) + ggtitle("GO:Cellular Compartment"))
  print(emapplot(GO.CC) + ggtitle("GO:Molecular Function"))
